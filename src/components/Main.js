...
const Main = ({ size }) => {
  return (
    <div className="relative w-full antialiased h-auto flex flex-col items-center">
      <div className="w-screen flex flex-col items-center mb-16 md:bg-illustration md:bg-70% lg:bg-60% xl:bg-50% bg-no-repeat max-w-[1440px] md:bg-[right_-6rem_center] lg:bg-[right_-9rem_center]">
      ...
      <div className="w-screen flex flex-col items-center justify-start max-w-[1440px] bg-gray-200 mt-16">
