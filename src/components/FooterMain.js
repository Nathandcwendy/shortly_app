...
const FooterMain = () => {
  return (
    <div className="flex items-center flex-col lg:flex-row w-11/12 2lg:w-5/6">
      ...
      <div className="w-full flex-col gap-y-14 md:gap-y-0 md:flex-row md:justify-center md:gap-x-8 lg:w-4/5 2lg:w-3/4 xl:w-2/3 flex lg:justify-between pt-6">
        <div className="flex flex-col xsm:flex-row w-full items-center xsm:items-start gap-y-8 xsm:gap-y-0 xsm:justify-between md:justify-center 2lg:justify-start md:gap-x-16 2lg:gap-x-20 xl:gap-x-24 lg:w-5/6">
          <div className="flex flex-col items-center xsm:items-start gap-y-4 xsm:gap-y-6">
            <h4 className="text-white font-bold">Features</h4>
            <ul className="text-GrayishViolet flex flex-col items-center xsm:items-start gap-y-3 xsm:gap-y-3">
              <li>
                <a className="hover:cursor-pointer hover:text-Cyan" href="/#">
                  Link Shortening
                </a>
              </li>
              <li>
